...
public class JobDetailsForm extends LokiForm {
    ...
    public JobDetailsForm(Job j) {
        ...
        if (job.isAutoFileTransfer()) {
            lblAutoFileTransfer.setText("启用");
        } else {
            lblAutoFileTransfer.setText("禁用");
        }
    ...
    private void setViewTime() {
        ...
        lblViewTime.setText(sFormat.format(currentTime));
    }

    private void setTxtOutput() {
        String txt = "***在任务列表中选择一个任务***";
        String cl = "";
    ...
    private void initComponents() {
        ...
        pnlDetail.setBorder(javax.swing.BorderFactory.createTitledBorder("普通"));

        jLabel1.setText("类型:");

        jLabel2.setText("状态:");

        jLabel3.setText("任务范围:");

        jLabel4.setText("项目文件:");

        jLabel5.setText("输出目录:");

        jLabel6.setText("输出文件前缀:");

        lblType.setText("Blender内部渲染器");

        lblStatus.setText("就绪");

        lblFirstFrame.setText("0");

        lblProjFile.setText("空");

        lblOutputDir.setText("空");

        lblFilePrefix.setText("空");

        jLabel8.setText("到");

        lblLastFrame.setText("0");

        jLabel13.setText("分块渲染:");

        lblTileRendering.setText("空");

        jLabel14.setText("文件自动传输:");

        lblAutoFileTransfer.setText("空");
        ...
        pnlTaskDetail.setBorder(javax.swing.BorderFactory.createTitledBorder("所选任务"));

        jLabel23.setText("任务命令行:");

        cbxOutput.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "标准输出", "错误输出" }));
        ...
        pnlTaskTally.setBorder(javax.swing.BorderFactory.createTitledBorder("任务记录"));
        ...
        jLabel21.setText("查看时间:");

        lblViewTime.setText("空");
